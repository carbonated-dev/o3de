...
namespace GridMate
{
    ...
    StreamSecureSocketDriver::~StreamSecureSocketDriver()
    {
        ...
        m_connectionFactory = [](AZ::u32 inboundBufferSize, AZ::u32 outputBufferSize)
        {
            ...
            AZ_Info("GridMateSecure", "Tried to create a new connection during shutdown.\n");
...
namespace GridMate
{
    ...
    bool StreamSecureSocketDriver::SecureConnection::SendPacket(const char* data, AZ::u32 dataSize)
    {
        ...
        {
            AZ_Info("GridMate", "Failed to memory write the packet");
            return false;
        }
        ...
        else
        {
            ...
            {
                AZ_Info("GridMate", "Writing was blocked by an internal SSL process.\n");
                return true;
            }
        }
        return false;

...
// Gruber patch begin // VMED -- added missed operator-() for time_point (because <AzCore/std/chrono/types.h> is missed)
    inline AZStd::chrono::milliseconds operator-(AZStd::chrono::system_clock::time_point p1, AZStd::chrono::system_clock::time_point p2)
    {
        return AZStd::chrono::duration_cast<AZStd::chrono::milliseconds>(p1.time_since_epoch() - p2.time_since_epoch());
    }

...
namespace GridMate
{
    ...
    */
    ...
    public:
        ...
        AZStd::string GetTaskName() override { return "ReplicaUpdateTask"; }
    ...
    */
    ...
    public:
        ...
        AZStd::string GetTaskName() override { return "ReplicaUpdateDestroyedProxyTask"; }
    ...
    */
    ...
    public:
        ...
        AZStd::string GetTaskName() override { return "ReplicaDestroyPeerTask"; }

...
#else
    bool CreateAchievementService(ServiceType type, const AchievementServiceDesc& desc, AchievementMgr*& service, const char*& serviceName){ return false; }
    bool CreateGridStorageService(ServiceType type, const GridStorageServiceDesc& desc, GridStorageService*& service, const char*& serviceName){ return false; }
    bool CreateLeaderboardService(ServiceType type, LeaderboardService*& leaderboardService, const char*& serviceName){ return false; }
#endif
 // gruber patch end
    }
}
...
{
    // Memory
// Gruber patch begin // VMED -- AZ::AllocatorInstance does not have IsReady() and Create()
/* Removed a manual RefCount using to destroy the AlocatorInstance manually due to in o3de this feature is not supported
    if (AZ::AllocatorInstance<GridMateAllocator>::IsReady())
    {
        AZ_Info("GridMate", "GridMate Allocator has already started! Ignoring current allocator descriptor!\n");
...
// Gruber patch begin // VMED -- AZ::AllocatorInstance does not have Destroy()
/* Removed a manual RefCount using to destroy the AlocatorInstance manually due to in o3de this feature is not supported
...
// Gruber patch begin // VMED -- .push_back() with emty arg is not supported
...
bool GridMateImpl::StartLeaderboardService(ServiceType type)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Leaderboard Service %s started!     =\n", serviceName);
    AZ_Info("GridMate", "================================================\n\n");
    return true;
}
...
bool GridMateImpl::StartLeaderboardServiceCustom(GridMate::LeaderboardService* userService)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "=================================================\n");
    AZ_Info("GridMate", "= GridMate Custom/User Leaderboard Service started! =\n");
    AZ_Info("GridMate", "=================================================\n\n");
...
void GridMateImpl::StopLeaderboardService()
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Leaderboard Service stopped!        =\n");
    AZ_Info("GridMate", "================================================\n\n");
}
...
bool GridMateImpl::StartAchievementService(ServiceType type, const AchievementServiceDesc& desc)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Achievement Service %s started!     =\n", serviceName);
    AZ_Info("GridMate", "================================================\n\n");
    return true;
}
...
bool GridMateImpl::StartAchievementServiceCustom(AchievementMgr* userService)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "=================================================\n");
    AZ_Info("GridMate", "= GridMate Custom/User Achievement Service started! =\n");
    AZ_Info("GridMate", "=================================================\n\n");
...
void GridMateImpl::StopAchievementService()
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Achievement Service stopped!        =\n");
    AZ_Info("GridMate", "================================================\n\n");
}
...
bool GridMateImpl::StartStorageService(ServiceType type, const GridStorageServiceDesc& desc)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Storage Service %s started!         =\n", serviceName);
    AZ_Info("GridMate", "================================================\n\n");
    return true;
}
...
bool GridMateImpl::StartStorageServiceCustom(GridStorageService* userService)
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "=================================================\n");
    AZ_Info("GridMate", "= GridMate Custom/User Storage Service started! =\n");
    AZ_Info("GridMate", "=================================================\n\n");
...
void GridMateImpl::StopStorageService()
{
    ...
    AZ_Info("GridMate", "\n");
    AZ_Info("GridMate", "================================================\n");
    AZ_Info("GridMate", "= GridMate Storage Service stopped!            =\n");
    AZ_Info("GridMate", "================================================\n\n");
}

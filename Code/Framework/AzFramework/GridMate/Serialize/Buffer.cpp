...
namespace GridMate
{
    ...
    {
// Gruber patch begin // VMED -- param #4 is redundant
        // was: return azmalloc(byteSize, alignment, GridMateAllocatorMP , "WriteBuffer");
        return azmalloc(byteSize, alignment, GridMateAllocatorMP);

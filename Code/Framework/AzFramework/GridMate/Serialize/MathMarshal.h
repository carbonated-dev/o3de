...
namespace GridMate
{
    ...
    */
    ...
    public:
        ...
        static constexpr AZStd::size_t MarshalSize = Marshaler<AZ::Quaternion>::MarshalSize + Marshaler<float>::MarshalSize + Marshaler<AZ::Vector3>::MarshalSize;
...
// Gruber patch begin // AVK
        void Marshal(WriteBuffer& wb, const AZ::Transform& value) const
        {
            ...
            quaternionMarshaler.Marshal(wb, value.GetRotation());
            floatMarshaler.Marshal(wb, value.GetUniformScale());
            vector3Marshaler.Marshal(wb, value.GetTranslation());
        }
        void Unmarshal(AZ::Transform& value, ReadBuffer& rb) const
        {
            ...
            AZ::Quaternion quaternionUnmarshaled;
            float floatUnmarshaled;
            AZ::Vector3 vector3Unmarshaled;

            quaternionMarshaler.Unmarshal(quaternionUnmarshaled, rb);
            floatMarshaler.Unmarshal(floatUnmarshaled, rb);
            vector3Marshaler.Unmarshal(vector3Unmarshaled, rb);

            value.SetRotation(quaternionUnmarshaled);
            value.SetUniformScale(floatUnmarshaled);
            value.SetTranslation(vector3Unmarshaled);
        }
// Gruber patch end
    };

    ...
    */
    ...
    public:
        ...
        void Unmarshal(DataType& obb, ReadBuffer& rb) const
        {
            ...
            AZ::Vector3 vector3;
            vector3Marshaler.Unmarshal(vector3, rb);
            obb.SetPosition(vector3);

            AZ::Quaternion quaternion;
            quaternionMarshaler.Unmarshal(quaternion, rb);
            obb.SetRotation(quaternion);

            vector3Marshaler.Unmarshal(vector3, rb);
            obb.SetHalfLengths(vector3);
#endif
            // Gruber patch end
        }
    };

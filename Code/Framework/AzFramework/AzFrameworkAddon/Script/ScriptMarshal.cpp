...
#include <AzFrameworkAddon/Network/DynamicSerializableFieldMarshaler.h>
#include <AzFrameworkAddon/Network/EntityIdMarshaler.h>

#include "AzFrameworkAddon/Script/ScriptMarshal.h"
        ...
        else if (typeId == AZ::ScriptPropertyTable::RTTI_Type())
        {
            ...
            // Unmarshal all of the hashed values
            {
                ...
                for (AZ::u32 i=0; i < mapSize; ++i)
                {
                    ...
                    auto mapIter = scriptPropertyTable->m_keyMapping.find(AZ::Crc32(newHash));

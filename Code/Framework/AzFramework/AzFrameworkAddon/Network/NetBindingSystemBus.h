...
namespace AzFramework
{
    ...
    */
    struct NetBindingSliceContext
    {
        ...
        /**
         * \brief uniquely identifies the spawnable instance that this entity is being replicated from
         */
    ...
    */
    ...
    public:
         ...
         */
        //virtual void UnbindGameEntity(AZ::EntityId entity, const AZ::SliceComponent::SliceInstanceId& sliceInstanceId) = 0;   // Gruber patch. LVB.
        virtual void UnbindGameEntity(AZ::EntityId entity, const SpawnableInstanceId& spawnableInstanceId) = 0;      // Gruber patch. LVB.
    };

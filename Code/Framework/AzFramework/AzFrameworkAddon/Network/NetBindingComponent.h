...
#include <AzFramework/Spawnable/SpawnableEntitiesInterface.h>  // Gruber patch // VMED
...
namespace AzFramework
{
    ...
    */
    class AZF_API NetBindingComponent
        : public AZ::Component
    ...
    protected:
        ...
        //void SetSliceInstanceId(const AZ::SliceComponent::SliceInstanceId& sliceInstanceId) override;     // Gruber patch. LVB.
        void SetSpawnableInstanceId(const SpawnableInstanceId& spawnableInstanceId) override;    // Gruber patch. LVB.

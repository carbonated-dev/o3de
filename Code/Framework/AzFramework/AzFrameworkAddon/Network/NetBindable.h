 ...
 */
#include <AzFrameworkAddon/Network/EntityIdMarshaler.h>
...
namespace AZ
{
     ...
     * last.
     */
    struct PointerRemovedTypeIdTag // Gruber patch // VMED
    {
    };
}
...
namespace AZ
{
    ...
    struct SerializeGenericTypeInfo< AzFramework::NetBindable::Field<DataType, MarshalerType, ThrottlerType> >
    {
        ...
        public:
            ...
            AZ::TypeId GetTemplatedTypeId(size_t) override // gruber patch
            {
                return SerializeGenericTypeInfo<DataType>::GetClassTypeId();
            }

            AZ::TypeId GetSpecializedTypeId() const override // gruber patch
            {
                return azrtti_typeid<ContainerType>();
            }

            AZ::TypeId GetGenericTypeId() const override // gruber patch
            {
                return TYPEINFO_Uuid();
            }

            AZ::TypeId GetLegacySpecializedTypeId() const override // gruber patch
            {

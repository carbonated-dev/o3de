...
*
*/
#include <AzFrameworkAddon/Network/InterestManagerComponent.h>
...
namespace AzFramework
{
    ...
    void InterestManagerComponent::OnNetworkSessionActivated(GridSession* session)
    {
        ...
        AZ_Info("AzFramework", "Interest manager hooked up to the session '%s'\n", session->GetId().c_str());
    ...
    void InterestManagerComponent::OnNetworkSessionDeactivated(GridSession* session)
    {
        ...
        {
            AZ_Info("AzFramework", "Interest manager disconnected from the session '%s'\n", session ? session->GetId().c_str() : "nullptr");

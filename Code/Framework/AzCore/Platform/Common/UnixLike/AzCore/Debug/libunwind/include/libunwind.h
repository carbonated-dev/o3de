...
extern int unw_getcontext1(unw_context_t *) LIBUNWIND_AVAIL;
extern int unw_init_local1(unw_cursor_t *, unw_context_t *) LIBUNWIND_AVAIL;
extern int unw_step1(unw_cursor_t *) LIBUNWIND_AVAIL;
extern int unw_get_reg1(unw_cursor_t *, unw_regnum_t, unw_word_t *) LIBUNWIND_AVAIL;
extern int unw_get_fpreg(unw_cursor_t *, unw_regnum_t, unw_fpreg_t *) LIBUNWIND_AVAIL;
extern int unw_set_reg1(unw_cursor_t *, unw_regnum_t, unw_word_t) LIBUNWIND_AVAIL;

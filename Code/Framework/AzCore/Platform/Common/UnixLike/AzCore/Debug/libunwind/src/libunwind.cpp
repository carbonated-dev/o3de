...
/*
extern "C" {
    int unw_getcontext1(unw_context_t *c)
    {
        return __unw_getcontext(c);
    }
}
*/
...
_LIBUNWIND_WEAK_ALIAS(__unw_init_local, unw_init_local1)
...
_LIBUNWIND_WEAK_ALIAS(__unw_get_reg, unw_get_reg1)
...
_LIBUNWIND_WEAK_ALIAS(__unw_set_reg, unw_set_reg1)
...
_LIBUNWIND_WEAK_ALIAS(__unw_step, unw_step1)

...
namespace AZ
{
    ...
    extern const VectorFloat AZCORE_API g_simdTolerance;
    extern const VectorFloat AZCORE_API g_fltMax;
    extern const VectorFloat AZCORE_API g_fltEps;
    extern const VectorFloat AZCORE_API g_fltEpsSq;
    ...
    #include <AzCoreAddon/Math/Internal/VectorFloatWin32.inl>
#else
    #include <AzCoreAddon/Math/Internal/VectorFloatFpu.inl>
#endif

...
namespace AZ
{
    ...
    namespace Debug
    {
        ...
        public:
            ...
            {
                StreamHeader()
                    : platform((u8)AZ::g_currentPlatform)    {}
                u8   platform;
            };
            ...
            void Write(u32 name, const AZ::VectorFloat& vf);
            ...
            {
                // we can specialize for continuous_random_access_iterator_tag so have only 1 write for all elements
                size_t numElements = distance(first, last, typename AZStd::iterator_traits<InputIterator>::iterator_category());
                ...
                WriteBinary(de);
                //WriteBinary(data,dataSize); for continuous_random_access_iterator_tag
        ...
        public:
            struct Data
            {
                ...
                {
                    static_assert(std::is_trivial<T>::value, "T must be plain-old-data");
                ...
                //////////////////////////////////////////////////////////////////////////
                // math types
                void Read(AZ::VectorFloat& vf) const;

...
namespace PhysX
{
    ...
    void CharacterControllerComponent::SetMaterialByName(uint32_t /* index*/, const AZStd::string& /*name*/) // Parameters commented to prevent warning C4100
    {
    ...
    void CharacterControllerComponent::SetTag(const AZ::Crc32& /*tag*/) // Parameters commented to prevent warning C4100
    {
        // This code is commented because not compatible with o3de
        /*

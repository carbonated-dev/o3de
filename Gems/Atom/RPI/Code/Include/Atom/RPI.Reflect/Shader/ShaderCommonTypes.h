...
namespace AZ
{
    namespace RPI
    {
        ...
        //! The NoSpecialization supervariant is auto-generated by the Shader Asset Builder.
        //! It uses the shader option fallback key instead of specialization constants.
        static constexpr const char* NoSpecializationSupervariantName = "NoSpecialization";

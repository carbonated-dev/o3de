...
namespace AZ
{
    namespace Vulkan
    {
            inline const char* BoolStr(VkBool32 v)
            {
                return v ? "TRUE" : "FALSE";
            }

            inline void DumpBool(const char* group, const char* field, VkBool32 supported, VkBool32 requested)
            {
                // Print everything (noisy but explicit):
                AZ_Printf(
                    "Vulkan",
                    "%s: %-50s supported=%s requested=%s%s\n",
                    group,
                    field,
                    BoolStr(supported),
                    BoolStr(requested),
                    (requested && !supported) ? "   <<< REQUESTED BUT NOT SUPPORTED !!!" : "");
            }

            static const char* VkStructureTypeToString(VkStructureType type)
            {
                switch (type)
                {
                ...
                default:
                    return "UNKNOWN_VK_STRUCTURE_TYPE";
                }
            }


// Helper macro: dumps one VkBool32 field
#define DUMP_BOOL(GROUP, SUP, REQ, FIELD) DumpBool((GROUP), #FIELD, (SUP).FIELD, (REQ).FIELD)

            // ---------- VkPhysicalDeviceFeatures (Vulkan 1.0) ----------
            inline void DumpSupportedVsRequested(
                const char* group, const VkPhysicalDeviceFeatures& sup, const VkPhysicalDeviceFeatures& req)
            {
                // Core 1.0 features
                DUMP_BOOL(group, sup, req, robustBufferAccess);
                DUMP_BOOL(group, sup, req, fullDrawIndexUint32);
                DUMP_BOOL(group, sup, req, imageCubeArray);
                DUMP_BOOL(group, sup, req, independentBlend);
                DUMP_BOOL(group, sup, req, geometryShader);
                DUMP_BOOL(group, sup, req, tessellationShader);
                DUMP_BOOL(group, sup, req, sampleRateShading);
                DUMP_BOOL(group, sup, req, dualSrcBlend);
                DUMP_BOOL(group, sup, req, logicOp);
                DUMP_BOOL(group, sup, req, multiDrawIndirect);
                DUMP_BOOL(group, sup, req, drawIndirectFirstInstance);
                DUMP_BOOL(group, sup, req, depthClamp);
                DUMP_BOOL(group, sup, req, depthBiasClamp);
                DUMP_BOOL(group, sup, req, fillModeNonSolid);
                DUMP_BOOL(group, sup, req, depthBounds);
                DUMP_BOOL(group, sup, req, wideLines);
                DUMP_BOOL(group, sup, req, largePoints);
                DUMP_BOOL(group, sup, req, alphaToOne);
                DUMP_BOOL(group, sup, req, multiViewport);
                DUMP_BOOL(group, sup, req, samplerAnisotropy);
                DUMP_BOOL(group, sup, req, textureCompressionETC2);
                DUMP_BOOL(group, sup, req, textureCompressionASTC_LDR);
                DUMP_BOOL(group, sup, req, textureCompressionBC);
                DUMP_BOOL(group, sup, req, occlusionQueryPrecise);
                DUMP_BOOL(group, sup, req, pipelineStatisticsQuery);
                DUMP_BOOL(group, sup, req, vertexPipelineStoresAndAtomics);
                DUMP_BOOL(group, sup, req, fragmentStoresAndAtomics);
                DUMP_BOOL(group, sup, req, shaderTessellationAndGeometryPointSize);
                DUMP_BOOL(group, sup, req, shaderImageGatherExtended);
                DUMP_BOOL(group, sup, req, shaderStorageImageExtendedFormats);
                DUMP_BOOL(group, sup, req, shaderStorageImageMultisample);
                DUMP_BOOL(group, sup, req, shaderStorageImageReadWithoutFormat);
                DUMP_BOOL(group, sup, req, shaderStorageImageWriteWithoutFormat);
                DUMP_BOOL(group, sup, req, shaderUniformBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderSampledImageArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageImageArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderClipDistance);
                DUMP_BOOL(group, sup, req, shaderCullDistance);
                DUMP_BOOL(group, sup, req, shaderFloat64);
                DUMP_BOOL(group, sup, req, shaderInt64);
                DUMP_BOOL(group, sup, req, shaderInt16);
                DUMP_BOOL(group, sup, req, shaderResourceResidency);
                DUMP_BOOL(group, sup, req, shaderResourceMinLod);
                DUMP_BOOL(group, sup, req, sparseBinding);
                DUMP_BOOL(group, sup, req, sparseResidencyBuffer);
                DUMP_BOOL(group, sup, req, sparseResidencyImage2D);
                DUMP_BOOL(group, sup, req, sparseResidencyImage3D);
                DUMP_BOOL(group, sup, req, sparseResidency2Samples);
                DUMP_BOOL(group, sup, req, sparseResidency4Samples);
                DUMP_BOOL(group, sup, req, sparseResidency8Samples);
                DUMP_BOOL(group, sup, req, sparseResidency16Samples);
                DUMP_BOOL(group, sup, req, sparseResidencyAliased);
                DUMP_BOOL(group, sup, req, variableMultisampleRate);
                DUMP_BOOL(group, sup, req, inheritedQueries);
            }

            // ---------- Descriptor Indexing EXT ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceDescriptorIndexingFeaturesEXT& sup,
                const VkPhysicalDeviceDescriptorIndexingFeaturesEXT& req)
            {
                DUMP_BOOL(group, sup, req, shaderInputAttachmentArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderUniformTexelBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageTexelBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderUniformBufferArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderSampledImageArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageBufferArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageImageArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderInputAttachmentArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderUniformTexelBufferArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageTexelBufferArrayNonUniformIndexing);
                DUMP_BOOL(group, sup, req, descriptorBindingUniformBufferUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingSampledImageUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingStorageImageUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingStorageBufferUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingUniformTexelBufferUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingStorageTexelBufferUpdateAfterBind);
                DUMP_BOOL(group, sup, req, descriptorBindingUpdateUnusedWhilePending);
                DUMP_BOOL(group, sup, req, descriptorBindingPartiallyBound);
                DUMP_BOOL(group, sup, req, descriptorBindingVariableDescriptorCount);
                DUMP_BOOL(group, sup, req, runtimeDescriptorArray);
            }

            // ---------- Buffer Device Address ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceBufferDeviceAddressFeatures& sup,
                const VkPhysicalDeviceBufferDeviceAddressFeatures& req)
            {
                DUMP_BOOL(group, sup, req, bufferDeviceAddress);
                DUMP_BOOL(group, sup, req, bufferDeviceAddressCaptureReplay);
                DUMP_BOOL(group, sup, req, bufferDeviceAddressMultiDevice);
            }

// Buffer Device Address (EXT)
#if defined(VK_EXT_buffer_device_address)
        inline void DumpSupportedVsRequested(
            const char* group,
            const VkPhysicalDeviceBufferDeviceAddressFeaturesEXT& sup,
            const VkPhysicalDeviceBufferDeviceAddressFeaturesEXT& req)
        {
            DumpBool(group, "bufferDeviceAddress", sup.bufferDeviceAddress, req.bufferDeviceAddress);
            DumpBool(group, "bufferDeviceAddressCaptureReplay", sup.bufferDeviceAddressCaptureReplay, req.bufferDeviceAddressCaptureReplay);
            DumpBool(group, "bufferDeviceAddressMultiDevice", sup.bufferDeviceAddressMultiDevice, req.bufferDeviceAddressMultiDevice);
        }
#endif
            ...
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceDepthClipEnableFeaturesEXT& sup,
                const VkPhysicalDeviceDepthClipEnableFeaturesEXT& req)
            {
                DUMP_BOOL(group, sup, req, depthClipEnable);
            }

            // ---------- Timeline Semaphore ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceTimelineSemaphoreFeatures& sup,
                const VkPhysicalDeviceTimelineSemaphoreFeatures& req)
            {
                DUMP_BOOL(group, sup, req, timelineSemaphore);
            }

            // ---------- Fragment Shading Rate KHR ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceFragmentShadingRateFeaturesKHR& sup,
                const VkPhysicalDeviceFragmentShadingRateFeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, pipelineFragmentShadingRate);
                DUMP_BOOL(group, sup, req, primitiveFragmentShadingRate);
                DUMP_BOOL(group, sup, req, attachmentFragmentShadingRate);
            }

            // ---------- Fragment Density Map EXT ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceFragmentDensityMapFeaturesEXT& sup,
                const VkPhysicalDeviceFragmentDensityMapFeaturesEXT& req)
            {
                DUMP_BOOL(group, sup, req, fragmentDensityMap);
                DUMP_BOOL(group, sup, req, fragmentDensityMapDynamic);
                DUMP_BOOL(group, sup, req, fragmentDensityMapNonSubsampledImages);
            }

            // ---------- Robustness2 EXT ----------
            inline void DumpSupportedVsRequested(
                const char* group, const VkPhysicalDeviceRobustness2FeaturesEXT& sup, const VkPhysicalDeviceRobustness2FeaturesEXT& req)
            {
                DUMP_BOOL(group, sup, req, robustBufferAccess2);
                DUMP_BOOL(group, sup, req, robustImageAccess2);
                DUMP_BOOL(group, sup, req, nullDescriptor);
            }

            // ---------- Ray Query KHR ----------
            inline void DumpSupportedVsRequested(
                const char* group, const VkPhysicalDeviceRayQueryFeaturesKHR& sup, const VkPhysicalDeviceRayQueryFeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, rayQuery);
            }

            // ---------- Acceleration Structure KHR ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceAccelerationStructureFeaturesKHR& sup,
                const VkPhysicalDeviceAccelerationStructureFeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, accelerationStructure);
                DUMP_BOOL(group, sup, req, accelerationStructureCaptureReplay);
                DUMP_BOOL(group, sup, req, accelerationStructureIndirectBuild);
                DUMP_BOOL(group, sup, req, accelerationStructureHostCommands);
                DUMP_BOOL(group, sup, req, descriptorBindingAccelerationStructureUpdateAfterBind);
            }

            // ---------- Ray Tracing Pipeline KHR ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceRayTracingPipelineFeaturesKHR& sup,
                const VkPhysicalDeviceRayTracingPipelineFeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, rayTracingPipeline);
                DUMP_BOOL(group, sup, req, rayTracingPipelineShaderGroupHandleCaptureReplay);
                DUMP_BOOL(group, sup, req, rayTracingPipelineShaderGroupHandleCaptureReplayMixed);
                DUMP_BOOL(group, sup, req, rayTracingPipelineTraceRaysIndirect);
                DUMP_BOOL(group, sup, req, rayTraversalPrimitiveCulling);
            }

            // ---------- Shader Atomic Int64 ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceShaderAtomicInt64Features& sup,
                const VkPhysicalDeviceShaderAtomicInt64Features& req)
            {
                DUMP_BOOL(group, sup, req, shaderBufferInt64Atomics);
                DUMP_BOOL(group, sup, req, shaderSharedInt64Atomics);
            }

            // ---------- Shader Image Atomic Int64 EXT ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT& sup,
                const VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT& req)
            {
                DUMP_BOOL(group, sup, req, shaderImageInt64Atomics);
                DUMP_BOOL(group, sup, req, sparseImageInt64Atomics);
            }

            // ---------- Float16/Int8 (KHR) ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceShaderFloat16Int8FeaturesKHR& sup,
                const VkPhysicalDeviceShaderFloat16Int8FeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, shaderFloat16);
                DUMP_BOOL(group, sup, req, shaderInt8);
            }

            // ---------- Separate Depth/Stencil Layouts (KHR) ----------
            inline void DumpSupportedVsRequested(
                const char* group,
                const VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR& sup,
                const VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR& req)
            {
                DUMP_BOOL(group, sup, req, separateDepthStencilLayouts);
            }

            // ---------- Vulkan 1.2 features ----------
            inline void DumpSupportedVsRequested(
                const char* group, const VkPhysicalDeviceVulkan12Features& sup, const VkPhysicalDeviceVulkan12Features& req)
            {
                // This is a big struct; dump the ones most likely to cause create-device failures or that engines commonly toggle.
                DUMP_BOOL(group, sup, req, samplerMirrorClampToEdge);
                DUMP_BOOL(group, sup, req, drawIndirectCount);
                DUMP_BOOL(group, sup, req, storageBuffer8BitAccess);
                DUMP_BOOL(group, sup, req, uniformAndStorageBuffer8BitAccess);
                DUMP_BOOL(group, sup, req, storagePushConstant8);
                DUMP_BOOL(group, sup, req, shaderBufferInt64Atomics);
                DUMP_BOOL(group, sup, req, shaderSharedInt64Atomics);
                DUMP_BOOL(group, sup, req, shaderFloat16);
                DUMP_BOOL(group, sup, req, shaderInt8);

                DUMP_BOOL(group, sup, req, descriptorIndexing);
                DUMP_BOOL(group, sup, req, shaderInputAttachmentArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderUniformTexelBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderStorageTexelBufferArrayDynamicIndexing);
                DUMP_BOOL(group, sup, req, shaderUniformBufferArrayNonUniformIndexing);
                ...
                DUMP_BOOL(group, sup, req, samplerFilterMinmax);
                DUMP_BOOL(group, sup, req, scalarBlockLayout);
                DUMP_BOOL(group, sup, req, imagelessFramebuffer);
                DUMP_BOOL(group, sup, req, uniformBufferStandardLayout);
                DUMP_BOOL(group, sup, req, shaderSubgroupExtendedTypes);
                DUMP_BOOL(group, sup, req, separateDepthStencilLayouts);
                DUMP_BOOL(group, sup, req, hostQueryReset);
                DUMP_BOOL(group, sup, req, timelineSemaphore);
                DUMP_BOOL(group, sup, req, bufferDeviceAddress);
                DUMP_BOOL(group, sup, req, bufferDeviceAddressCaptureReplay);
                DUMP_BOOL(group, sup, req, bufferDeviceAddressMultiDevice);
                DUMP_BOOL(group, sup, req, vulkanMemoryModel);
                DUMP_BOOL(group, sup, req, vulkanMemoryModelDeviceScope);
                DUMP_BOOL(group, sup, req, vulkanMemoryModelAvailabilityVisibilityChains);
                DUMP_BOOL(group, sup, req, shaderOutputViewportIndex);
                DUMP_BOOL(group, sup, req, shaderOutputLayer);
                DUMP_BOOL(group, sup, req, subgroupBroadcastDynamicId);
            }

            // Optional: Vulkan 1.3 features (if you have them available in your branch)
            inline void DumpSupportedVsRequested_IfAvailable(
                const char* group, const VkPhysicalDeviceVulkan13Features& sup, const VkPhysicalDeviceVulkan13Features& req)
            {
                DUMP_BOOL(group, sup, req, robustImageAccess);
                DUMP_BOOL(group, sup, req, inlineUniformBlock);
                DUMP_BOOL(group, sup, req, descriptorBindingInlineUniformBlockUpdateAfterBind);
                DUMP_BOOL(group, sup, req, pipelineCreationCacheControl);
                DUMP_BOOL(group, sup, req, privateData);
                DUMP_BOOL(group, sup, req, shaderDemoteToHelperInvocation);
                DUMP_BOOL(group, sup, req, shaderTerminateInvocation);
                DUMP_BOOL(group, sup, req, subgroupSizeControl);
                DUMP_BOOL(group, sup, req, computeFullSubgroups);
                DUMP_BOOL(group, sup, req, synchronization2);
                DUMP_BOOL(group, sup, req, textureCompressionASTC_HDR);
                DUMP_BOOL(group, sup, req, shaderZeroInitializeWorkgroupMemory);
                DUMP_BOOL(group, sup, req, dynamicRendering);
                DUMP_BOOL(group, sup, req, shaderIntegerDotProduct);
                DUMP_BOOL(group, sup, req, maintenance4);
            }
...
#undef DUMP_BOOL
        ...
        RHI::ResultCode Device::InitInternal(RHI::PhysicalDevice& physicalDeviceBase)
        {
            ...
            auto PF = [&](const char* name, VkBool32 v)
            {
                AZ_Printf("Vulkan", "  Feature %-40s = %s\n", name, v ? "TRUE" : "FALSE");
            };
            ...
            AZ_Printf("Vulkan", "Requested VkPhysicalDeviceDescriptorIndexingFeaturesEXT:\n");
            PF("descriptorBindingPartiallyBound", descriptorIndexingFeatures.descriptorBindingPartiallyBound);
            PF("descriptorBindingVariableDescriptorCount", descriptorIndexingFeatures.descriptorBindingVariableDescriptorCount);
            PF("runtimeDescriptorArray", descriptorIndexingFeatures.runtimeDescriptorArray);
            PF("descriptorBindingSampledImageUpdateAfterBind", descriptorIndexingFeatures.descriptorBindingSampledImageUpdateAfterBind);
            // ...
            ...
            if (majorVersion >= 1 && minorVersion >= 2)
            {
                ...
                AZ_Printf("Vulkan", "Requested VkPhysicalDeviceVulkan12Features:\n");
                PF("descriptorIndexing", vulkan12Features.descriptorIndexing);
                PF("descriptorBindingPartiallyBound", vulkan12Features.descriptorBindingPartiallyBound);
                PF("descriptorBindingVariableDescriptorCount", vulkan12Features.descriptorBindingVariableDescriptorCount);
                PF("runtimeDescriptorArray", vulkan12Features.runtimeDescriptorArray);
                PF("bufferDeviceAddress", vulkan12Features.bufferDeviceAddress);
                PF("timelineSemaphore", vulkan12Features.timelineSemaphore);
                PF("separateDepthStencilLayouts", vulkan12Features.separateDepthStencilLayouts);
            }
            else
            {
            ...
            auto DumpPNextChain = [](const void* pNext)
            {
                AZ_Printf("Vulkan", "DeviceCreateInfo.pNext chain:\n");

                int i = 0;
                const VkBaseOutStructure* cur = reinterpret_cast<const VkBaseOutStructure*>(pNext);
                ...
                while (cur)
                {
                    AZ_Printf(
                        ...
                        "  [%d] %s (sType=%d)\n",
                        i,
                        VkStructureTypeToString(static_cast<VkStructureType>(cur->sType)),
                        cur->sType);

                    cur = cur->pNext;
                    if (++i > 64)
                    {
                        AZ_Printf("Vulkan", "  (chain too long, abort)\n");
                        break;
                    }
                }
            };

            DumpPNextChain(deviceInfo.pNext);


            auto DumpCStrList = [](const char* tag, const RawStringList& list)
            {
                AZ_Printf("Vulkan", "%s count=%zu\n", tag, list.size());
            ...
            DumpCStrList("Enabled layers", requiredLayers);
            DumpCStrList("Enabled extensions", requiredExtensions);
            ...
            AZ_Printf("Vulkan", "Requested VkPhysicalDeviceFeatures:\n");
            PF("samplerAnisotropy", m_enabledDeviceFeatures.samplerAnisotropy);
            PF("textureCompressionETC2", m_enabledDeviceFeatures.textureCompressionETC2);
            PF("textureCompressionBC", m_enabledDeviceFeatures.textureCompressionBC);
            PF("fragmentStoresAndAtomics", m_enabledDeviceFeatures.fragmentStoresAndAtomics);
            PF("dualSrcBlend", m_enabledDeviceFeatures.dualSrcBlend);
            PF("imageCubeArray", m_enabledDeviceFeatures.imageCubeArray);
            PF("pipelineStatisticsQuery", m_enabledDeviceFeatures.pipelineStatisticsQuery);
            PF("occlusionQueryPrecise", m_enabledDeviceFeatures.occlusionQueryPrecise);
            PF("depthClamp", m_enabledDeviceFeatures.depthClamp);
            PF("depthBiasClamp", m_enabledDeviceFeatures.depthBiasClamp);
            PF("depthBounds", m_enabledDeviceFeatures.depthBounds);
            PF("fillModeNonSolid", m_enabledDeviceFeatures.fillModeNonSolid);
            PF("multiDrawIndirect", m_enabledDeviceFeatures.multiDrawIndirect);
            PF("sampleRateShading", m_enabledDeviceFeatures.sampleRateShading);
            PF("shaderImageGatherExtended", m_enabledDeviceFeatures.shaderImageGatherExtended);
            PF("shaderInt64", m_enabledDeviceFeatures.shaderInt64);
            PF("shaderInt16", m_enabledDeviceFeatures.shaderInt16);
            PF("sparseBinding", m_enabledDeviceFeatures.sparseBinding);
            PF("geometryShader", m_enabledDeviceFeatures.geometryShader);
            PF("tessellationShader", m_enabledDeviceFeatures.tessellationShader);

            {
                // 1) Vulkan 1.0 features
                const auto& sup10 = physicalDevice.GetPhysicalDeviceFeatures();
                const VkPhysicalDeviceFeatures& req10 = m_enabledDeviceFeatures;
                DumpSupportedVsRequested("VkPhysicalDeviceFeatures (1.0)", sup10, req10);

                // 2) Descriptor indexing EXT
                const auto& supDI = physicalDevice.GetPhysicalDeviceDescriptorIndexingFeatures();
                DumpSupportedVsRequested("VkPhysicalDeviceDescriptorIndexingFeaturesEXT", supDI, descriptorIndexingFeatures);

                // 3) Buffer Device Address
                const auto& supBDA = physicalDevice.GetPhysicalDeviceBufferDeviceAddressFeatures();
                DumpSupportedVsRequested("VkPhysicalDeviceBufferDeviceAddressFeaturesEXT", supBDA, bufferDeviceAddressFeatures);

                // 4) Timeline semaphore (если ты реально используешь timelineSemaphore struct)
                const auto& supTS = physicalDevice.GetPhysicalDeviceTimelineSemaphoreFeatures();
                DumpSupportedVsRequested("VkPhysicalDeviceTimelineSemaphoreFeatures", supTS, timelineSemaphore);

                // 5) Vulkan 1.2 features (если ветка >= 1.2)
                if (majorVersion >= 1 && minorVersion >= 2)
                {
                    const auto& sup12 = physicalDevice.GetPhysicalDeviceVulkan12Features();
                    DumpSupportedVsRequested("VkPhysicalDeviceVulkan12Features", sup12, vulkan12Features);
                }

                // 6) Остальные (если реально используешь эти структуры и они у тебя есть)
                DumpSupportedVsRequested(
                    "VkPhysicalDeviceDepthClipEnableFeaturesEXT",
                    physicalDevice.GetPhysicalDeviceDepthClipEnableFeatures(),
                    depthClipEnabled);

                DumpSupportedVsRequested(
                    "VkPhysicalDeviceRobustness2FeaturesEXT", physicalDevice.GetPhysicalDeviceRobutness2Features(), robustness2);

                DumpSupportedVsRequested("VkPhysicalDeviceRayQueryFeaturesKHR", physicalDevice.GetRayQueryFeatures(), rayQueryFeatures);

                DumpSupportedVsRequested(
                    "VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT",
                    physicalDevice.GetShaderImageAtomicInt64Features(),
                    shaderImageAtomicInt64);
                ...
                DumpSupportedVsRequested(
                    ...
                    physicalDevice.GetPhysicalDeviceRayTracingPipelineFeatures(),
                    rayTracingPipelineFeatures);

                // Fragment rate/density (если используешь):
                DumpSupportedVsRequested(
                    "VkPhysicalDeviceFragmentShadingRateFeaturesKHR",
                    physicalDevice.GetPhysicalDeviceFragmentShadingRateFeatures(),
                    fragmenShadingRateFeatures);

                DumpSupportedVsRequested(
                    "VkPhysicalDeviceFragmentDensityMapFeaturesEXT",
                    physicalDevice.GetPhysicalDeviceFragmentDensityMapFeatures(),
                    fragmenDensityMapFeatures);
            }

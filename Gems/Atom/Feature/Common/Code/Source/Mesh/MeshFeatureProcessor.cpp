...
namespace AZ
{
    namespace Render
    {
        ...
        MeshFeatureProcessor::MeshHandle MeshFeatureProcessor::AcquireMesh(const MeshHandleDescriptor& descriptor)
        {
            ...
            // insertion
#if defined(CARBONATED) && defined(AZ_ASSET_TRACING) // AZ_ASSET_TRACING to avoid unused variables error in release build
...
#if defined(CARBONATED)
            MEMORY_TAG(Mesh);
            [[maybe_unused]] const char* assetName = "UnknownModelDataInstance";

...
namespace AZ
{
    namespace Render
    {
        ...
        AZ_CVAR(int, r_directionalShadowFilteringSampleCountMode, 0, nullptr, AZ::ConsoleFunctorFlags::DontReplicate, "Cvar to override directional shadow sample count mode. -1 = Default settings from Editor, 0 = PcfTap4, 1 = PcfTap9, 2 = PcfTap16");

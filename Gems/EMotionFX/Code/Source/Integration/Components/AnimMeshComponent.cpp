...
namespace EMotionFX
{
    namespace Integration
    {
        ...
        void AnimMeshComponent::Configuration::Reflect(AZ::ReflectContext* context)
        {
        ...
        AZ::Crc32 AnimMeshComponent::Configuration::GetBlendOutTimeVisibility() const
        {
        ...
        AZ::Crc32 AnimMeshComponent::Configuration::GetFreezeAtLastFrameVisibility() const
        {
            return m_loop ? AZ::Edit::PropertyVisibility::Hide : AZ::Edit::PropertyVisibility::Show;
        }

        void AnimMeshComponent::Reflect(AZ::ReflectContext* context)
        {
            ...
            if (serializeContext)
            {
                serializeContext->Class<AnimMeshComponent, AZ::Component>()
                    ->Version(1)->Field(
                    "Configuration", &AnimMeshComponent::m_configuration)
                    ;
            }
        ...
        AnimMeshComponent::Configuration::Configuration()
            : m_loop(false)
            , m_retarget(false)
            , m_reverse(false)
            , m_mirror(false)
        ...
        AnimMeshComponent::AnimMeshComponent(const Configuration* config)
        ...
        void AnimMeshComponent::Init()
        {
        }

        void AnimMeshComponent::Activate()
        {
            m_motionInstance = nullptr;
        ...
        void AnimMeshComponent::Deactivate()
        {
        ...
        const MotionInstance* AnimMeshComponent::GetMotionInstance()
        {
            return m_motionInstance;
        }

        void AnimMeshComponent::SetMotionAssetId(const AZ::Data::AssetId& assetId)
        {
            m_configuration.m_motionAsset = AZ::Data::Asset<MotionAsset>(assetId, azrtti_typeid<MotionAsset>());
        }

        void AnimMeshComponent::OnModelReady(const AZ::Data::Asset<AZ::RPI::ModelAsset>& modelAsset, const AZ::Data::Instance<AZ::RPI::Model>& model)
        {
            model;
            modelAsset;
        }

        void AnimMeshComponent::OnAssetReady(AZ::Data::Asset<AZ::Data::AssetData> asset)
        {
            auto& cfg = m_configuration;
        ...
        void AnimMeshComponent::OnAssetReloaded(AZ::Data::Asset<AZ::Data::AssetData> asset)
        {
            OnAssetReady(asset);
        }

        void AnimMeshComponent::PlayMotion()
        {
            m_motionInstance = PlayMotionInternal(m_actorInstance.get(), m_configuration, /*deleteOnZeroWeight*/true);
        }

        void AnimMeshComponent::RemoveMotionInstanceFromActor(EMotionFX::MotionInstance* motionInstance)
        {
            if (motionInstance)
            {
        ...
        void AnimMeshComponent::LoopMotion(bool enable)
        {
        ...
        bool AnimMeshComponent::GetLoopMotion() const
        {
            return m_configuration.m_loop;
        }

        void AnimMeshComponent::RetargetMotion(bool enable)
        {
        ...
        void AnimMeshComponent::ReverseMotion(bool enable)
        {
        ...
        void AnimMeshComponent::MirrorMotion(bool enable)
        {
        ...
        void AnimMeshComponent::SetPlaySpeed(float speed)
        {
        ...
        float AnimMeshComponent::GetPlaySpeed() const
        {
            return m_configuration.m_playspeed;
        }

        void AnimMeshComponent::PlayTime(float time)
        {
            if (m_motionInstance)
            {
        ...
        float AnimMeshComponent::GetPlayTime() const
        {
            float result = 0.0f;
            if (m_motionInstance)
            {
        ...
        float AnimMeshComponent::GetDuration() const
        {
            return m_motionInstance ? m_motionInstance->GetDuration() : 0.0f;
        }

        void AnimMeshComponent::Motion(AZ::Data::AssetId assetId)
        {
        ...
        AZ::Data::AssetId AnimMeshComponent::GetMotion() const
        {
            return m_configuration.m_motionAsset.GetId();
        }

        void AnimMeshComponent::BlendInTime(float time)
        {
            m_configuration.m_blendInTime = time;
        }

        float AnimMeshComponent::GetBlendInTime() const
        {
            return m_configuration.m_blendInTime;
        }

        void AnimMeshComponent::BlendOutTime(float time)
        {
            m_configuration.m_blendOutTime = time;
        }

        float AnimMeshComponent::GetBlendOutTime() const
        {
            return m_configuration.m_blendOutTime;
        }

        EMotionFX::MotionInstance* AnimMeshComponent::PlayMotionInternal(
            const EMotionFX::ActorInstance* actorInstance, const AnimMeshComponent::Configuration& cfg, bool deleteOnZeroWeight)
        {

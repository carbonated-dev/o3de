...
namespace EMotionFX
{
    namespace Integration
    {
        ...
        public:
            ...
            AZ_EDITOR_COMPONENT(EditorAnimMeshComponent, "{7FF1BDF7-DA51-4183-89EC-BDD7D2E17D36}");

            EditorAnimMeshComponent();
            ~EditorAnimMeshComponent() override;
            ...
            {
                AnimMeshComponent::GetProvidedServices(provided);
            }

            static void GetDependentServices(AZ::ComponentDescriptor::DependencyArrayType& dependent)
            {
                AnimMeshComponent::GetDependentServices(dependent);
            }

            static void GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& required)
            {
                AnimMeshComponent::GetRequiredServices(required);
            }

            static void GetIncompatibleServices(AZ::ComponentDescriptor::DependencyArrayType& incompatible)
            {
                AnimMeshComponent::GetIncompatibleServices(incompatible);
            }
        ...
        private:
            EditorAnimMeshComponent(const EditorAnimMeshComponent&) = delete;
            ...
            AnimMeshComponent::Configuration m_configuration;
